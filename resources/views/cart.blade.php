...
function updateQuantity(qty) {
    ...
    // Log untuk melihat apakah updateQuantity dipanggil dan nilai yang dikirim
    console.log('RowID:', rowid);
    console.log('Quantity:', quantity);

    $('#rowid').val(rowid);
    $('#quantity').val(quantity);
    $('#updateCartQty').submit();  // Kirim form untuk memperbarui keranjang
}
function removeItemFromCart(rowid) {
    console.log('RowId to remove:', rowid);  // Debugging
    $('#rowId_D').val(rowid);  // Set value of hidden input
    $('#deleteFromCart').submit();  // Submit form to trigger remove action
}
function clearCart(){
    $('#clearCart').submit(); // Kirim form untuk menghapus semua isi keranjang
}
 </script>
@endpush
